...
### 느낀 점
- Jquery로 작성한 코드를 Javascrip로 변경하면서 많은 시행착오도 있었지만 그 과정에서 Javascript로 DOM을 조작하고 styling 하는 부분에 대한 감을 익힐 수 있어서 좋았습니다. 추가로 수정/보완이 필요한 부분이 있는데, 이 부분은 다시 방법을  구현하겠니다. 
